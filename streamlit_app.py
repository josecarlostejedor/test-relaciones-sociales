...
if st.session_state.step == 1:
    st.title("Registro del candidato para Becas Europa")
    with st.form("ident"):
        ...
        if st.form_submit_button("Acceder al Test"):
            if nom and ape:
                ...
                st.rerun()
    st.markdown("<p style='text-align: center; color: #94a3b8; font-size: 0.85rem; margin-top: 1rem; font-style: italic;'>(App made by Jose Carlos Tejedor)</p>", unsafe_allow_html=True)
