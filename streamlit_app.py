...
# URL estable del logo cuadrado azul (basada en el logo oficial proporcionado)
LOGO_URL = "https://yt3.ggpht.com/ytc/AIdro_n8-9u7U-0l_9mG5jY-YnF7o-9i_8G-Yk1Z=s900-c-k-c0x00ffffff-no-rj"
...
# CABECERA: Imagen del logo corregida para Streamlit
...
if st.session_state.step == 1:
    ...
    with st.form("social_form"):
        ...
        if st.form_submit_button("Finalizar y Generar Informe"):
            # Cálculos de percentiles para la demo
